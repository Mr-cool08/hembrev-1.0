...
class Application(tk.Frame):
    def __init__(self, master=None):
        ...
        self.widgets = []
        self.current_theme = "lightgrey"
        self.text_color = "black"
    
    def switch_theme(self):
    if self.current_theme == "lightgrey":
        self.current_theme = "#121212"
        self.text_color = "white"
    else:
        self.current_theme = "lightgrey"
        self.text_color = "black"
    for widget in self.widgets:
        widget.config(bg=self.current_theme, fg=self.text_color)
    self.config(bg=self.current_theme)
    ...
    def create_widgets(self):
        ...
        def questions(self):
            ...
            self.matte_gör.grid(row=1, column=1, sticky="w", bg=self.current_theme, fg=self.text_color)
        ...
        self.button = tk.Button(self, text="Switch theme", command=self.switch_theme)
